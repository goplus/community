...
<template>
    ...
    <!-- <vue-plyr ref="plyr">
        <video ref="plyr" class="plyr" :autoplay="autoplay" :crossorigin="crossorigin" :poster="poster" :playsinline="playsinline">
...
export default  {
    data() {
        return {
            // source: 'https://cdn.plyr.io/static/demo/View_From_A_Blue_Moon_Trailer-576p.mp4', // 修改为你的本地视频路径
            // autoplay: true,
